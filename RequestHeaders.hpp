...
private:
	...
	std::map<std::string, float>	_acceptCharset;
	std::map<std::string, float>	_acceptLanguage;
...
public:
	...
	std::map<std::string, float>	get_acceptCharset() const;
	std::map<std::string, float>	get_acceptLanguage() const;
