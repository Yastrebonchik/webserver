...
HEADERS = methods.h RequestHeaders.hpp ResponseHeaders.hpp ConnectionClass.hpp utils.hpp #cgi.hpp
...
SRCS = main.cpp RequestHeaders.cpp ResponseHeaders.cpp methods.cpp ConnectionClass.cpp utils.cpp #cgi.cpp
